...
def get_installed():
    ...
    if settings.OVERLAY_ROOT in installed_themes:
        del installed_themes[settings.OVERLAY_ROOT]
    ...
    def run(self, overwrite=False):
        ...
        for pkg in installed_themes:
            for theme in installed_themes[pkg]:
                ...
                if pkg not in customizable_themes or force_mode:
                    ...
                    if os.path.exists(new) and not force_mode:
